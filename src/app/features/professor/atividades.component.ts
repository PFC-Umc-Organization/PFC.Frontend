  ...
  template: `
    <div class="page">
      <header>
        ...
        <h1 class="page-title mt-2">Atividades</h1>
        <p class="lead mt-2">
                  ...
                  <tr>
                    <td colspan="5">
                      ...
                      <form
                        ...
                        [formGroup]="editForm"
                        (ngSubmit)="salvarEdicao(r.atividade.id)"
                      >
                        <div class="field">
                          <label class="field__label" for="edit-titulo">
                            Título da atividade
                          </label>
                          <input
                            id="edit-titulo"
                            ...
                            class="control"
                            formControlName="titulo"
                            [class.control--invalid]="invalidoEdicao('titulo')"
                          />
                          @if (invalidoEdicao('titulo')) {
                        ...
                        <div class="field">
                          <label class="field__label" for="edit-prazo">
                            Data e hora limite
                          </label>
                          <input
                            id="edit-prazo"
                            ...
                            class="control"
                            formControlName="prazo"
                            [class.control--invalid]="invalidoEdicao('prazo')"
                          />
                          @if (invalidoEdicao('prazo')) {
                            <span class="field__error">
                    ...
                    <td>
                      <div class="row">
                        <button
                          type="button"
                          class="acao-remover"
                          (click)="iniciarEdicao(r.atividade)"
                          [attr.aria-label]="
...
export class AtividadesComponent {
  ...
  invalidoEdicao(campo: 'titulo' | 'prazo'): boolean {
  ...
  iniciarEdicao(atividade: Atividade): void {
    this.erroEdicao.set('');
    this.editandoId.set(atividade.id);
  ...
  salvarEdicao(atividadeId: string): void {
    ...
    this.atividades
      .atualizar(atividadeId, this.editForm.getRawValue())
      .subscribe({
